...
外接电源，将4WD麦克纳姆轮小车下板上的拨码开关拨到 “<span style="color: rgb(255, 76, 65);">**OFF**</span>” 端。选择好正确的开发板板型（Arduino Uno）和 适当的串口端口（COMxx），然后单击 ![Arduino_2.3.6-a40](../../media/Arduino_2.3.6-a40.png) 按钮上传示例代码至Arduino控制板。
...
- 打开电源：将4WD麦克纳姆轮小车下板上的拨码开关拨到 “<span style="color: rgb(255, 76, 65);">**ON**</span>” 端。
